...
//			(Palindrome number or not) + (Scanner class)
		...
		/*
		 * Scanner sc=new Scanner(System.in); System.out.println("Enter any no"); int no
		 * = sc.nextInt(); int temp =no; int rev = 0, rem; while(temp != 0) { rem = temp
		 * % 10; //1, 2, 1, rev = rev * 10 + rem; //1, 12, 121, temp=temp/10; //12, 1,
		 * 0.1 } if(no==rev) { System.out.println(no+ " Palindrome No"); }else {
		 * System.out.println(no+ " Not a Palindrome No"); }
		 */

//		3. unary operator [--> here refer unary package - ]
		/*
		 * int x=10; -->11 -->12 -->11 -->10 System.out.println(x++); //10
...
//		4. Ternary operator [--> here refer Ternary seperate package - ]
		...
		/*
		 * int x = 20; int y = 10; System.out.println((x>y)?
...
//			(Right shift)
		/*
		 * int x=20; System.out.println(x>>2);
		 */
...
//		6.	Calculate percentage of 5 subjects
		/*
		 * int sub1=50; int sub2=60; int sub3=70; int sub4=80; int sub5=90; int sum=
		 * sub1+sub2+sub3+sub4+sub5; double total=500.00;
		 * 
		 * double percentage = (sum/total)*100; System.out.println(percentage);
		 */

		// (Calculate percentage of 5 subjects) + (Scanner class)
		/*
		 * Scanner sc=new Scanner(System.in);
		 * System.out.println("Enter marks of sub 1"); int sub1=sc.nextInt();
		 * System.out.println("Enter marks of sub 2"); int sub2=sc.nextInt();
		 * System.out.println("Enter marks of sub 3"); int sub3=sc.nextInt();
		 * System.out.println("Enter marks of sub 4"); int sub4=sc.nextInt();
		 * System.out.println("Enter marks of sub 5"); int sub5=sc.nextInt(); int sum=
		 * sub1+sub2+sub3+sub4+sub5; double total=500.00;
		 * 
...
//			i] Array fill - 
		 ...
		 * 
		 * Arrays.fill(num, new Object() { int count = 0;
		 * 
...
//			ii] BitSet:
		...
		/*
		 * String set = new BitSet() {{set(1,101);}}.toString(); System.out.append(set,
		 * 1, set.length());
		 */
...
//		50. Print your name 1000 times without using any loop in java - 
		...
		/*
		 * String name = "sohel"; String s = "i";
		 * 
		 * s = s.replaceAll("i", "iiiiiiiiii"); //1 * 10 --> 10 s = s.replaceAll("i",
		 * "iiiiiiiiii"); //10 * 10 --> 100 s = s.replaceAll("i", "iiiiiiiiii"); //100 *
		 * 10 --> 1000
		 * 
...
//		51. Leap year or not -
		...
		/*
		 * Scanner sc = new Scanner(System.in); System.out.println("Enter year here- ");
		 * int year = sc.nextInt(); if(year % 400 == 0 || year % 4 == 0 && year % 100 !=
		 * 0) { System.out.println("Leap year"); }else {
...
//		54. Java Streams - Square, filter & average of numbers - 
		 ...
		 * 
		 * double avg = list.stream() .map(e -> e*e) .filter(e -> e>100) .mapToInt(e ->
		 * e) .average() .getAsDouble(); //smfmag System.out.println(avg);
		 */
...
//			System.out.println("Even no: "+evenList);
		...
		// Odd numbers -
		/*
		 * List<Integer> oddList = list.stream() .filter(e -> e%2 != 0)
		 * .collect(Collectors.toList()); //sfc System.out.println("Odd No: "+oddList);
		 */
...
//			In Ascending order -->
		 ...
		 * List<Integer> sortedSet = list.stream() .sorted()
...
//			In Decending order - 
		 ...
		 * .sorted(Collections.reverseOrder()) .collect(Collectors.toList()); //ssc
...
//		63. WAP to convert ArrayList to String array - 
		 ...
		 * 
		 * al.add("Banglore"); al.add("Pune"); al.add("Mumbai");
		 * 
		 * String[] arr = new String[al.size()];
		 * 
		 * for(int i=0; i<al.size(); i++) { arr[i] = al.get(i); }
		 * 
		 * for(String j:arr) { System.out.println(j); }
		 */
...
//		64. WAP to copy all elements from one array into another array - 
		 ...
		 * 
		 * System.out.println("Displaying elements of an array 2 - "); // for loop -
		 * for(int i=0; i<arr2.length; i++) { System.out.print(arr2[i]+" "); }
		 * System.out.println("\n"); // foreach loop - for(int i:arr2) {
		 * System.out.print(i+" "); }
		 */
...
//		65. WAP to find square root of a number without sqrt method - 
		...
		/*
		 * double sq = Math.sqrt(25); System.out.println("Square root of 25 is "+sq);
		 */

		/// Without using sqrt method - [nts - tst]

		/*
		 * int num = 9; double temp ; double sr = num/2; //9/2 --> 4
		 * 
		 * do { temp = sr; //4, 3 sr = (temp+(num/temp))/2; //(4+(9/4)/2 = (4+2)/2 = 3
...
//		67. what will be the output ?
		...
		/*
		 * String x = "abc"; String y = "abc"; x.concat(y); //Output --> abc x =
		 * x.concat(y); //Output --> abcabc System.out.println(x);
		 */
...
//		69. Labels in java - 
		...
		/*
		 * System.out.println("Hello"); naveen: // --> this is nothing but labels...
		 * System.out.println("OK! Bye");
		 * 
		 * task: // --> this is nothing but labels... for(int i=1; i<=10; i++) {
		 * System.out.println(i); if(i == 5) { break task; } }
		 */

		/*
		 * outerLoop: for(int i=0; i<5; i++) { innerLoop: for(int j=0; j<5; j++) { if(i
		 * != j) { System.out.println("If block values "+i); break outerLoop; }else {
		 * System.out.println("Else block values "+i); break innerLoop; } } }
		 */
...
//		70. String joiner interview questions - 
		...
		/*
		 * String input = "Hello How are you"; //input String[] inputArray =
		 * input.split(" "); //split & convert to string array StringJoiner joiner = new
		 * StringJoiner("-", "[", "]"); //use stringjoiner class for(String
		 * inputArr:inputArray) { //foreach joiner.add(inputArr); //joiner class add
		 * method use } System.out.println(joiner.toString());
		 */ // use toString
		 ...
		 * 
		 * String output = inputList.stream() .collect(Collectors.joining("-")); //sc
...
//		71. Optional class - 
		 ...
		 * com.codeprep.optional - [PACKAGE] - OptionalExample - [CLASS]
		 */
...
//		list3.stream().forEach(e -> System.out.println(e));
		...
		// 1. Filtering:
		/*
		 * Stream<String> filteredNames = Arrays.stream(names) .filter(e ->
		 * e.startsWith("A")); filteredNames.forEach(System.out::println);
		 */

		// Arrays.stream(names).filter(e ->
		// e.startsWith("A")).forEach(System.out::println);
		...
		// 3. Sorting:
		/*
		 * Stream<String> sortedNames = Arrays.stream(names) .sorted();
...
//		74. Interface - Default & static method 
		...
		// for Interface - Default & static method plz refer [package
		// com.codeprep.Int.def.sta.meth;]
...
//		77. How to compare two HashMaps in java ? 
		 ...
		 * 
		 * map1.put(1, "A"); map1.put(2, "B"); map1.put(3, "C");
		 * 
		 * HashMap<Integer, String> map2 = new HashMap<>();
		 * 
		 * map2.put(2, "B"); map2.put(1, "A"); map2.put(3, "C");
		 * 
		 * HashMap<Integer, String> map3 = new HashMap<>();
		 * 
		 * map3.put(1, "A"); map3.put(2, "B"); map3.put(3, "C"); map3.put(3, "D");
		 * 
		 ...
		 * HashMap<Integer, String> map4 = new HashMap<>(); map4.put(1, "A");
		 * map4.put(2, "B"); map4.put(3, "C"); map4.put(4, "D");
		 * 
		 * HashSet<Integer> combineKeys = new HashSet<>(map1.keySet()); //[1,2,3]
		 * 
		 * combineKeys.addAll(map4.keySet()); //[4] System.out.println(combineKeys);
		 * //[1,2,3,4] combineKeys.removeAll(map1.keySet()); //[1,2,3 - 4]
